...
class ClientMovie:
    ...
    # all of the urls
    def run(self, rawUrl):
        tags = {'科幻': 156, '爱情': 377, '喜剧': 392, '动画': 274, '剧情': 392, '科幻': 155, '动作': 198, '悬疑': 209, '青春': 160,
                '犯罪': 227, '惊悚': 190, '文艺': 135, '搞笑': 148, '战争': 88, '纪录片': 260, '励志': 81, '短片': 174}
        ...
        try:
            ...
            for _ in content:
                ...
                if float(score) >= 8.0:
                    ...
                    info.append(score)
                    info.append(img)
                    fileName = open("/home/sunnyin/Project/Python/ProjectOfSelf/DouBan/Data/Movie/" + tag + ".csv",
                                    'a+')
                    try:
